        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header" style="display: flex; justify-content:space-between;">
                  <p style="position: relative; top:5px;">{{ __('Data Pengguna') }}</p>
                  <a href="{{ route('pengguna.create') }}" class="btn btn-primary w-20">Add</a>
                </div>
                @if (session('success'))
                    ...
                    <table class="table" style="width: 90%; margin:0 auto;">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>{{ $data->nama }}</td>
                            <td>
                              <div class="" style="display: flex; gap:3px; position: relative; left: 110px;">
